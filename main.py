...
#Test to do a search
# searchterm = input("Enter the search criteria\n>> ")
# results = db.PerformSearch(searchterm)

# #Get each index only once
# for index in results:
#     print(f"{db.database['items'][index]['productName']}")
# print("-------")
# primaryResult = db.database["items"][results[0]]
# print(f'{primaryResult["productNumber"]} === {primaryResult["productName"]}')
# print("----------\nVariations\n----------")
# for variation in primaryResult["variations"]:
#     print(f'{variation["variantID"]} === {variation["variationName"]}\nCost: £{variation["variationCost"]}')
